...
class TestChat:
    ...
    @pytest.mark.asyncio
    async def test_chat_success(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_chat_with_conversation_history(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_chat_suggested_prompt(self, async_client, auth_headers):
        """Test that chat can return suggested prompts."""
        # Mock will return a response with "SUGGESTED PROMPT:" in it
        with pytest.mock.patch("app.services.claude_service.ClaudeService.chat") as mock:
            mock.return_value = {
    ...
    @pytest.mark.asyncio
    async def test_chat_no_auth(self, async_client):
    ...
    @pytest.mark.asyncio
    async def test_chat_empty_message(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_chat_missing_message(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_chat_claude_unavailable(self, async_client, auth_headers):
        """Test chat when Claude is unavailable."""
        with pytest.mock.patch("app.services.claude_service.ClaudeService.is_available", False):
            response = await async_client.post(
                "/api/v1/chat",
                headers=auth_headers,
                json={"message": "Hello"},
    ...
    @pytest.mark.asyncio
    async def test_chat_invalid_conversation_history(self, async_client, auth_headers):
...
class TestEnhancePrompt:
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_success(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_with_style(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_with_negative(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_style_suggestions(self, async_client, auth_headers):
        """Test that enhancement returns style suggestions."""
        # Mock to return style suggestions
        with pytest.mock.patch("app.services.claude_service.ClaudeService.enhance_prompt") as mock:
            mock.return_value = {
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_no_auth(self, async_client):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_empty(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_missing(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_too_long(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_claude_unavailable(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_special_characters(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_unicode(self, async_client, auth_headers, mock_claude_api):
        """Test enhancing prompt with unicode characters."""
        prompt = "Un café avec du thé 🍵"
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_idempotent(self, async_client, auth_headers, mock_claude_api):
    ...
    @pytest.mark.asyncio
    async def test_enhance_prompt_all_parameters(self, async_client, auth_headers, mock_claude_api):
